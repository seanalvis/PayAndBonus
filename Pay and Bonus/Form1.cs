...
namespace Pay_and_Bonus
{
    public partial class Form1 : Form
    {
        ...
        // is successful, the method returns true. Other wise it returns
        // false.
        private bool InputIsInvalid(ref decimal pay, ref decimal bonus)
        {
        ...
        private void calculateButton_Click(object sender, EventArgs e)
        {
            ...
            if(InputIsInvalid(ref grossPay, ref bonus))
            {
